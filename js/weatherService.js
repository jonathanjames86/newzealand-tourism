angular.module('nzApp').service('weatherService', function($http, $q) {
    ...
    var hobbington = $http({
        method: 'GET',
        url: 'http://api.openweathermap.org/data/2.5/weather?q=matamata&units=imperial&APPID=a6d105d92252d6adf49ad53604180038',
        cache: 'true'
    });
    var milford = $http({
        method: 'GET',
    ...
    $q.all([auckland, queenstown, hobbington, milford, capeR]).then(function(data) {
